...
delay(2000);
cout<<"\n\n\n\t\tPLEASE PRESS ENTER TO CONTINUE & Esc.\t";
char ch;
for(;;)
{
ch=getch();
...
cout <<"\n                      ~~~~~~~~~~~ MAIN MENU ~~~~~~~~~~~\n" ;
gotoxy(32,10) ;
cout <<"1: NORMAL MODE ---> EDIT   " ;
gotoxy(32,12) ;
cout <<"2: CHECK LIST ---> VOTING LIST & CANDIDATE LIST " ;
gotoxy(32,14) ;
cout <<"3: ELECTION MODE ---> VOTING  " ;
gotoxy(32,16);
cout <<"4: RULES AND REGULATIONS";
gotoxy(32,18) ;
cout <<"0: QUIT " ;
gotoxy(32,23) ;
cout <<"Enter Choice : " ;
...
if (ch == '3')
{
cout<< "\n\n ENTER THE PASSWORD TO START THE VOTING:";
...
cout<<"-----------------------------------------------------"<<endl;
delay(150);
cout <<" \n\n  1. EVERY VOTER CAN VOTE ONLY ONCE FOR ONE ELECTION.";
cout <<" \n\n  2. YOU CAN ADD/DELETE/MODIFY YOUR INFORMATION IN NORMAL MODE ONLY.";
cout <<" \n\n  3. VOTING PROCESS IS TAKE PLACE IN ELECTION MODE ONLY.";
cout <<" \n\n  4. AFTER VOTING PROCESS RESULT WILL BE DISPLAY.";
...
cout <<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" ;
gotoxy(3,4) ;
cout <<"VOTER-CODE      NAME              AGE          GENDER" ;
gotoxy(2,5) ;
cout <<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" ;
while (file.read((char *)&vr, sizeof(voter_record)))
{
...
{
gotoxy(5,3) ;
cout <<"VOTER Code : "<<vr.voter_namecode ;
gotoxy(5,4) ;
...
gotoxy(1,25) ; clreol() ;
gotoxy(3,25) ;
cout <<"ENTER CODE TO ADD IN THE MENU" ;
gotoxy(5,12) ;
cout <<"Voter-Code : " ;
gets(t_namecode) ;
...
cout <<"Press <ENTER> to see the list" ;
gotoxy(5,3) ;
cout <<"Enter Code of the item to be Modify : " ;
gets(t_code) ;
tcode = atoi(t_code) ;
if (tcode == 0)
{
...
gotoxy(1,25) ; clreol() ;
gotoxy(3,25) ;
cout <<"ENTER CANDIDTE CODE TO ADD IN THE MENU" ;
gotoxy(5,12) ;
cout <<"Candidte Code : " ;
gets(t_namecode) ;
...
{
gotoxy(5,3) ;
cout <<"Candidate Code : "<<cr.candidate_namecode ;
gotoxy(5,4) ;
...
cout <<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" ;
gotoxy(2,4) ;
cout <<"CANDIDATE-CODE    NAME     PARTY-NAME    PARTY-SIGN    REVENUE    AGE    AREA";
gotoxy(1,5) ;
cout <<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" ;
while (file.read((char *)&cr, sizeof(candidate_record)))
{
...
gotoxy(3,24) ;
clreol();
cout <<"To End the voting Enter 'RESULT PASSWORD'.\n";
gotoxy(3,25);
clreol();
...
gotoxy(6,3);
clreol();
cout <<"Enter the voter code <To view list of voters press <ENTER>- ";
gets(name);
...
float vp=0;
gotoxy(20,3);
cout<<"\n\n         :: TOTAL NUMBER OF CANDIDATES: "<<num_candidates;
delay(200);
cout<<"\n\n         :: TOTAL NUMBER OF VOTERS: "<<num_voters;
for(i=0;i<num_candidates;i++)
{
  it=it+cs[i].numVotes;
}

vp=(it*100)/(num_voters);
delay(200);
cout<<"\n\n         :: TOTAL VOTE COUNT OF ELECTION: "<<it<<endl;
delay(200);
cout<<"\n\n         :: VOTING PERCENTAGE OF ELECTION: "<<vp<<" %"<<endl;
delay(500);
for(i = 0; i < num_candidates; i++)
{
candidate_record ct;
candidate_recordno(cs[i].candidate_namecode,ct);
cout<<"\n         :: CANDIDATE NAME: "<<ct.candidate_name<<"\t---> Total votes obtained: "<<cs[i].numVotes;
...
else cout <<"  ::: --- WINNER OF THIS ELECTION IS --->>> ::: ";
gotoxy(20,21);
for(i = 0; i < num_candidates; i++)
{
if (cs[i].numVotes == max)
...
gotoxy(20,5);
cout<<"\n------------------------------------------------------------------------\n ";
cout << "\n\t     *****\t WINNER'S NAME : "<<cr.candidate_name<<"\t*****"<<endl;
cout<<"\n------------------------------------------------------------------------\n\n "<<endl;
delay(200);
gotoxy(17,11);
cout<<"::::: THE WINNER'S SUMMARY FOLLOWS :::::"<<endl;
delay(500);
gotoxy(20,13);
delay(500);
cout<<"   :: Total vote obtained by winner'"<<cr.candidate_name<<"' -->"<<max<<endl;
gotoxy(20,15);
delay(500);
